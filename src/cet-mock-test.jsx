  ...
  return (
    <div style={{minHeight:"100vh",background:C.bg}}><NavBar student={student} />
      <div style={{maxWidth:880,margin:"0 auto",padding:"28px 20px"}}>
        ...
        {student.plan==="free"&&<Card style={{padding:"12px 20px",marginBottom:16,background:"linear-gradient(135deg,#0E1B2E,#1E3A5F)",border:"none"}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}><div onClick={onPragati} style={{cursor:"pointer",flex:1}}><div style={{fontSize:14,fontWeight:600,color:"#fff"}}>✨ Pragati — 1 free topic per subject <span style={{opacity:0.7,fontWeight:400}}>›</span></div><p style={{fontSize:12,color:"rgba(255,255,255,0.6)",marginTop:2}}>Tap to open · Upgrade to Premium to unlock all topics</p></div><Btn onClick={(e)=>{e.stopPropagation();setShowPlans(true);}} style={{background:"#D97706",padding:"8px 16px",borderRadius:8,fontSize:12,color:"#fff",flexShrink:0}}>Unlock All ₹499</Btn></div></Card>}
